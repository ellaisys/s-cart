...
//menuLeft
        $data['menuLeft'][] = '<a class="btn   btn-flat btn-primary grid-refresh" title="Refresh"><i class="fa fa-refresh"></i><span class="hidden-xs"> ' . trans('brand.admin.refresh') . '</span></a>';
//=menuLeft
