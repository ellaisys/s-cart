...
class DiscountAdminController extends Controller
{
    ...
    public function index()
    {
        ...
        $data['resultItems'] = trans($this->plugin->pathPlugin.'::Discount.admin.result_item', ['item_from' => $dataTmp->firstItem(), 'item_to' => $dataTmp->lastItem(), 'item_total' => $dataTmp->total()]);
