...
class InsertDatabaseAdmin extends Migration
{
    ...
    public function up()
    {
        ...
        DB::table(SC_DB_PREFIX.'admin_permission')->insert([
            ...
            ['id' => '4', 'name' => 'Setting manager', 'slug' => 'setting.full', 'http_uri' => 'ANY::sc_admin/store_info/*,ANY::sc_admin/store_value/*,ANY::sc_admin/url_config/*,ANY::sc_admin/product_config/*, ANY::sc_admin/customer_config/*, ANY::sc_admin/cache_config/*, ANY::sc_admin/env/*,ANY::sc_admin/email/*,ANY::sc_admin/email_template/*,ANY::sc_admin/language/*,ANY::sc_admin/currency/*,ANY::sc_admin/backup/*', 'created_at' => date('Y-m-d H:i:s')],
